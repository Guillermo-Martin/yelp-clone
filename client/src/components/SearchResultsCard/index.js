...
function SearchResultsCard() {
  return (
    <Card className="SearchResultsCard">
      <Link to="#"><Card.Img variant="top" src="https://images.unsplash.com/photo-1534308983496-4fabb1a015ee?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=3455&q=80" /></Link>
      <Card.Body>
